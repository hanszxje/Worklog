...
### 5.3.3. Security and Network Configurations
...
* Save the screenshot in the project directory at: `static/images/5-Workshop/5.3-Database-setup/rds-console.png` and remove the comment markdown notation.

<!-- ![RDS Console](/images/5-Workshop/5.3-Database-setup/rds-console.png) -->
