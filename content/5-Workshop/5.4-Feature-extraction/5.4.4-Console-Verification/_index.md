...
### 5.4.4. Console Verification Proofs
...
##### Screenshot Guide:
* Capture a screenshot of the Glue Jobs console page showing these jobs and save the image at: `static/images/5-Workshop/5.4-Feature-extraction/glue-jobs.png` and remove the comment markdown tags.
