...
### 5.4.4. Minh chứng hoạt động trên AWS Console
...
* Chụp màn hình danh sách jobs hiển thị cả 2 tác vụ trên và lưu vào thư mục dự án của bạn theo đường dẫn: `static/images/5-Workshop/5.4-Feature-extraction/glue-jobs.png` và xóa comment dòng dưới đây.

![Glue Jobs](/images/5-Workshop/5.4-Feature-extraction/glue-jobs.png)
