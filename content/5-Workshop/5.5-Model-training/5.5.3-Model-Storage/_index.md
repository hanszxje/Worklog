...
### 5.5.3. Staging and Uploading Model Artifacts to S3
...
* Save the screenshot in: `static/images/5-Workshop/5.5-Model-training/s3-models.png` and remove the comment markdown tags.
