...
### 5.6.1. Implementing the Forecast API on AWS Lambda
...
* Save the screenshot in: `static/images/5-Workshop/5.6-Model-api/lambda-api.png` and remove the comment markdown tags.
