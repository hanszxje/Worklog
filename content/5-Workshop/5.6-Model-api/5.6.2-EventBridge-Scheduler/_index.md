...
### 5.6.2. Pipeline Automation via Amazon EventBridge
...
* Save the screenshot in: `static/images/5-Workshop/5.6-Model-api/eventbridge-schedule.png` and remove the comment markdown tags.
