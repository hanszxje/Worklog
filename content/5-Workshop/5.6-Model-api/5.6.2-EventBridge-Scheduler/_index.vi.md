...
### 5.6.2. Tự động hóa Pipeline với Amazon EventBridge
...
* Lưu ảnh vào: `static/images/5-Workshop/5.6-Model-api/eventbridge-schedule.png` và bỏ comment dòng dưới đây.
